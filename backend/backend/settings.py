...
LOCAL_VIDEO_ROOT = Path(os.environ.get("LOCAL_VIDEO_ROOT", MEDIA_ROOT))
LOCAL_VIDEO_URL = os.environ.get("LOCAL_VIDEO_URL", MEDIA_URL)
if not LOCAL_VIDEO_URL.startswith("/"):
    LOCAL_VIDEO_URL = f"/{LOCAL_VIDEO_URL}"
if not LOCAL_VIDEO_URL.endswith("/"):
    LOCAL_VIDEO_URL = f"{LOCAL_VIDEO_URL}/"
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_PAGINATION_CLASS": "apps.common.pagination.PageSizePagination",
    "PAGE_SIZE": 24,
}
